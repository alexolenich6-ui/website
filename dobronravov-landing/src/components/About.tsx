...
const credentials = [
  ...
  "Опыт работы в психиатрической клинике «Медси», Москва",
  "Руководитель постлечебной программы реабилитационного центра",
  "Бакалавр теологии",
          ...
          <div className="col-span-12 lg:col-span-6 lg:col-start-7 flex flex-col justify-center">
            ...
            <AnimateIn delay={0.15}>
              <p className="font-sans text-[15px] md:text-[16px] font-light leading-[1.95] text-paper/70 mb-7">
                Сначала было служение православным священником. Годы рядом
                с&nbsp;людьми в&nbsp;самые тяжёлые моменты: горе, утрата,
                зависимость, болезнь. Вопросы, на&nbsp;которые нет лёгких ответов.
              </p>
            </AnimateIn>
            ...
            <AnimateIn delay={0.2}>
              <p className="font-sans text-[15px] md:text-[16px] font-light leading-[1.95] text-paper/70 mb-7">
                ...
                в&nbsp;психиатрической клинике. Там я&nbsp;научился видеть,
                где кризис, а&nbsp;где патология. Где нужна беседа,
                а&nbsp;где — медикаментозное лечение.
              </p>
            </AnimateIn>

            <AnimateIn delay={0.25}>
              <p className="font-sans text-[15px] md:text-[16px] font-light leading-[1.95] text-paper/70 mb-12">
                Так и&nbsp;сложилась моя профессиональная идентичность.
                Всегда встречаюсь с&nbsp;человеком в&nbsp;тяжёлые моменты
                его жизни, и&nbsp;вместе мы&nbsp;находим выход.
              </p>
            </AnimateIn>

...
const points = [
  {
    ...
    body: "Сессия — не отчёт о проступках. Это место, где можно по-настоящему поговорить с собой — вслух и рядом с тем, кто не осудит.",
  },
  {
    n: "02",
    title: "Идём к корню, не к симптому",
    body: "Я работаю не быстрыми приёмами, а вглубь. Симптом — верхушка. Под ним убеждения и паттерны, которые держат в кругу. Туда и идём.",
  },
  {
    n: "03",
    title: "Чтобы дальше ты шёл сам",
    body: "Моя цель — не сделать тебя зависимым от терапии. А вернуть опору внутрь, чтобы дальше ты справлялся сам.",
  },
];

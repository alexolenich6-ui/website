...
const lines = [
  "Просыпаешься — и уже устал. Хотя день только начался.",
  "Вроде всё нормально: работа, семья, дела. А внутри пусто. Как будто живёшь не свою жизнь.",
  "Говоришь себе: «Соберись», «Не ной», «У других хуже». Не помогает.",
  "Заглушаешь — работой, телефоном, чем угодно — лишь бы не чувствовать.",
  "Иногда кажется, что ты один такой, что у всех всё в порядке, а у тебя — нет.",
];
      ...
      <div className="max-w-[1240px] mx-auto">
        ...
        <AnimateIn delay={0.2}>
          <p className="mt-14 md:mt-20 font-serif italic font-light text-[clamp(1.7rem,4.4vw,3.4rem)] leading-[1.2] tracking-[-0.02em] text-gold">
            Если узнаёшь себя — я&nbsp;рядом. Разберёмся.
          </p>
        </AnimateIn>
      </div>
    </section>

...
const lines = [
  "Внешне всё нормально — работа, семья, обязательства.",
  "А внутри будто разваливается.",
  "Ты как будто живёшь не свою жизнь.",
  "Заглушаешь, чтобы не чувствовать.",
      ...
      <div className="max-w-[1240px] mx-auto">
        ...
        <AnimateIn delay={0.2}>
          <p className="mt-14 md:mt-20 font-serif italic font-light text-[clamp(1.7rem,4.4vw,3.4rem)] leading-[1.2] tracking-[-0.02em] text-gold">
            Если это про тебя — ты&nbsp;пришёл по&nbsp;адресу.
          </p>
        </AnimateIn>
      </div>
    </section>
